...
%path_test = '/home/va/some_codes/dataset/Data/PennPed/refractored/';
pattern= fullfile(path_test,'*.dat');
Files=dir(pattern);

%path_ground = '/home/va/some_codes/outData_dat/ground_check/';
path_ground = '/home/va/some_codes/outData_dat/PennPed/refractored/';
pattern= fullfile(path_ground,'*.dat');
Files_ground=dir(pattern);
total = 0;
correct = 0;
fileID_print = fopen('IOU_PennPed_HPU.dat','w');
disp('Hello');
